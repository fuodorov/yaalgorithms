...
ВРЕМЕННАЯ СЛОЖНОСТЬ
    ...
    В случае применения алгоритма Прима на основе массива программе требуется количество шагов ~ количеству вершин. При этом на каждом шаге мы находим минимальное (максимальное) по весу ребро. В худшем случае
